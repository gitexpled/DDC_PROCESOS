   ...
   $scope.listarMaterialZVER =[];
    ...
    $scope.embalajePakingContinuar = function(){
        ...
        var jsonValidate=[
                ...
                {campo:"Cantidad",value:$rootScope.datosMI.cantidad,type:"input"},
                {campo:"Cantidad Envase",value:$rootScope.datosMI.cantidadEnvase,type:"input"},
                {campo:"Material",value:$rootScope.datosMI.material,type:"aSelect",index:"MATNR"},
                {campo:"Tipo Bins",value:$rootScope.datosMI.tipoBins,type:"aSelect",index:"MATNR"},
                {campo:"Calibre",value:$rootScope.datosMI.calibre,type:"aSelect",index:"VALUE_CHAR"},
            ];
        if($rootScope.userData.mail=="servicio"){
            jsonValidate.push({campo:"Cliente",value:$rootScope.datosMI.cliente,type:"aSelect",index:"VALUE_CHAR"})
        }
